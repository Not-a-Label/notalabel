...
export default function DashboardNav() {
  ...
  const navigation = [
    ...
    { name: 'Merch', href: '/dashboard/merch', icon: ShoppingBagIcon },
  ...
  return (
    <>
      ...
      <nav className="hidden lg:flex bg-gray-800 border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-1">
              ...
              <button
                onClick={() => signOut()}
                className="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white transition-colors ml-4"
              >
